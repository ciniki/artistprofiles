...
function ciniki_artistprofiles_settingsHistory($ciniki) {
    ...
    $rc = ciniki_artistprofiles_checkAccess($ciniki, $args['tnid'], 'ciniki.artistprofiles.settingsHistory', 0, 0);
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    return ciniki_core_dbGetModuleHistory($ciniki, 'ciniki.artistprofiles', 'ciniki_artistprofiles_history', 
        $args['tnid'], 'ciniki_artistprofiles_settings', $args['setting'], 'detail_value');
}
?>
