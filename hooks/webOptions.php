...
// -------
//
function ciniki_artistprofiles_hooks_webOptions(&$ciniki, $tnid, $args) {
    ...
    $rc = ciniki_core_dbDetailsQueryDash($ciniki, 'ciniki_web_settings', 'tnid', $tnid, 'ciniki.web', 'settings', 'page-artistprofiles');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
